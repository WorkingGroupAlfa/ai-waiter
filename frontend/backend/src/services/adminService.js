...
import {
  ...
  fetchUpsellAcceptanceByReasonCode,
  fetchUpsellAcceptanceBySourceKind,
  fetchUpsellSkipReasons,
...
export async function getUpsellAcceptanceByReasonCode(restaurantId) {
  return fetchUpsellAcceptanceByReasonCode(restaurantId);
}

export async function getUpsellAcceptanceBySourceKind(restaurantId) {
  return fetchUpsellAcceptanceBySourceKind(restaurantId);
}

export async function getUpsellSkipReasons(restaurantId) {
  return fetchUpsellSkipReasons(restaurantId);
}
